...
export const NodeActionsSheet = ({
  ...
  const [openConfigDialog, setOpenConfigDialog] = useState(!!preSelectedAction)
  ...
  return (
    <>
      ...
      {/* SHEET - only show if no preSelectedAction */}
      {!preSelectedAction && (
      ...
      {/* When preSelectedAction exists, still render the button but it opens the dialog */}
      {preSelectedAction && (
        <Button
          size='sm'
          variant='outline'
