...
export const CREDENTIALS_OPTIONS = [
  ...
  },
  {
    ...
    name: 'Discord',
    icon: discordIcon,
    url: `https://discord.com/oauth2/authorize?client_id=1466759269763514513&permissions=8&response_type=code&redirect_uri=${BACKEND_BASE_URL}/api/discord/oauth&integration_type=0&scope=email+bot`,
    description: 'Add a bot to a server to manage interactions'
  }
]
